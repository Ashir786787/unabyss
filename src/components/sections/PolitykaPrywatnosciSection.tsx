...
import { politykaMeta, politykaSections } from "@/data/polityka";

export default function PolitykaPrywatnosciSection() {
  return (
    <>
          ...
          <Reveal className="mb-14">
            <div className="flex flex-col items-start gap-3">
              ...
              <div className="v2-mono flex flex-col gap-1 text-[12px] tracking-[0.08em] text-white/40">
                <span>{politykaMeta.updated}</span>
              </div>
            </div>
          </Reveal>
